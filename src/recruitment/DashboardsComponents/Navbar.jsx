...
const Navbar = () => {
  ...
  const groupedLinks = [
    ...
    { title: "Cover Letters", links: ["CoverLettersAnalyses", "CoverLettersPoints"], icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-3 md:size-6">
  ...
  return (
    <nav className="flex items-start top-32 left-0 z-20 p-2 sticky">
      <div className="navbar flex flex-col bg-glass rounded-xl w-[90px] md:w-[250px]">
