...
const Overview = ({ id }) => {
  ...
  const stageColors = [
    { stage: 'Paused', color: ' from-red-500 to-red-700', description: 'The recruiter paused recruitment process.' },
    { stage: 'Collecting applicants', color: 'from-gray-500 to-gray-700', description: 'The recruiter is still in the process of collecting applicants.' },
    { stage: 'Checking applications', color: 'from-blue-500 to-blue-700', description: 'The recruiter is currently checking applications.' },
    { stage: 'Interviewing applicants', color: ' from-yellow-500 to-yellow-700', description: 'The recruiter is currently interviewing applicants.' },
    { stage: 'Scoring tasks', color: ' from-pink-500 to-pink-700', description: 'The recruiter is currently scoring tasks.' },
    { stage: 'Offering jobs', color: 'from-purple-500 to-purple-700', description: 'The recruiter is currently offering jobs.' },
    { stage: 'Hiring employees', color: ' from-green-500 to-green-700', description: 'The recruiter is currently hiring employees.' },
      ...
      <div className="h-screen-80 overflow-auto px-2">
        ...
        <div className="py-4  rounded-2xl shadow-lg text-white w-full overflow-x-auto mb-6 inner-shadow px-2">
          ...
          <div className="relative flex items-center justify-between min-w-[800px] px-1">
            ...
            {/* Pasek postępu */}
            <div
              className={`absolute top-1/2 left-[1%] h-9 transition-all duration-500 rounded-full bg-gradient-to-l ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 w-full ">
          {/* Total Applicants */}
          <div className="p-4 md:p-6 bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl shadow-lg text-white flex items-center gap-4 w-full  shadow-slate-950">
          ...
          {/* Highest Score */}
          <div className="p-4 md:p-6 bg-gradient-to-r from-green-600 to-yellow-600 rounded-2xl shadow-lg text-white flex items-center gap-4 w-full shadow-slate-950">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12">
          ...
          {/* Average Score */}
          <div className="p-4 md:p-6 bg-gradient-to-r from-yellow-600 to-red-600 rounded-2xl shadow-lg text-white flex items-center gap-4 w-full shadow-slate-950">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-12">
          ...
          {/* Total Meetings */}
          <div className="p-4 md:p-6 bg-gradient-to-r from-red-600 to-purple-600 rounded-2xl shadow-lg text-white flex items-center gap-4 w-full shadow-slate-950">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-12">
          ...
          {/* Total Tasks */}
          <div className="p-4 md:p-6 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl shadow-lg text-white flex items-center gap-4 w-full shadow-slate-950">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12">
          ...
          <div className="p-4 md:p-6 bg-gradient-to-r from-pink-600 to-orange-600 rounded-2xl shadow-lg text-white flex items-center gap-4 w-full shadow-slate-950">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12">
